...
export function PricingSection({ onNavigate, onSelectProductForQuote }: PricingSectionProps) {
  ...
  return (
    <section id="pricing" className="py-16 lg:py-24 bg-[#FDFBF7] border-b border-[#EAE2D5]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-[#EAE2D5] p-6 sm:p-8 shadow-2xs">
              <h3 className="font-serif text-2xl font-bold text-[#362C2B] mb-2">
                CUSTOM PRODUCTS
              </h3>
              <p className="text-xs text-[#8C7A78] mb-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-[#EAE2D5] bg-[#FAF7F2] text-xs font-bold uppercase text-[#4A3E3D]">
                  ...
                  <tbody className="divide-y divide-[#EAE2D5]/60 text-sm">
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">📌 Custom Pin</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Round</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">1–9 pcs</td>
                      <td className="py-3 px-4 font-bold text-[#362C2B] text-right">AED 15</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">📌 Custom Pin</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Square</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">1–9 pcs</td>
                      <td className="py-3 px-4 font-bold text-[#362C2B] text-right">AED 15</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">🧲 Custom Magnet</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Round</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">1–9 pcs</td>
                      <td className="py-3 px-4 font-bold text-[#362C2B] text-right">AED 18</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">🧲 Custom Magnet</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Square</td>
                    ...
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">🪞 Custom Mirror</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Round</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">1–9 pcs</td>
                      <td className="py-3 px-4 font-bold text-[#362C2B] text-right">AED 22</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-semibold text-[#362C2B]">🪞 Custom Mirror</td>
                      <td className="py-3 px-4 text-[#5C4D4A]">Square</td>
            ...
            <div className="bg-white rounded-3xl border border-[#EAE2D5] p-6 sm:p-8 shadow-2xs">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="bg-[#C86D51] text-white text-[11px] font-extrabold uppercase px-3 py-1 rounded-full">
                  Save Up to 40%
                </span>
              </div>
              <p className="text-xs text-[#8C7A78] mb-6">
              ...
              <div className="space-y-3">
                {PRICING_TIERS.map((tier) => (
                  <div
                    key={tier.range}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-[#FAF7F2] border border-[#EAE2D5] hover:border-[#C86D51] transition-colors"
                  >
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="font-bold text-[#362C2B] text-base">{tier.range}</span>
                        <span className="text-xs font-semibold text-[#C86D51] bg-white px-2.5 py-0.5 rounded-full border border-[#EAE2D5]">
                          {tier.label}
                        </span>
                      </div>
                      <p className="text-xs text-[#5C4D4A] mt-1">{tier.note}</p>
                    </div>

                    <div className="mt-2 sm:mt-0 text-left sm:text-right">
                      <span className="text-sm font-extrabold text-[#362C2B]">
              ...
              <div className="mt-6 p-4 rounded-2xl bg-[#F3ECE2] border border-[#EAE2D5] flex items-start space-x-3">
                <HelpCircle className="w-5 h-5 text-[#C86D51] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <p className="text-xs font-medium text-[#4A3E3D] leading-relaxed">
          ...
          <div className="lg:col-span-5 sticky top-24">
            <div className="bg-gradient-to-br from-[#362C2B] to-[#4A3E3D] text-white rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
              
              <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-white/10">
                <div className="p-2.5 bg-[#C86D51] rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#EAE2D5]">Estimate your custom order in AED</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <label className="text-xs font-bold uppercase tracking-wider text-[#EAE2D5] block mb-2">
                    1. Select Product
                  </label>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#EAE2D5]">
                      3. Quantity Needed
                    </label>
                    <span className="text-xs font-extrabold bg-[#C86D51] text-white px-2.5 py-0.5 rounded-full">
                      {calcQuantity} pcs
                    </span>
                  </div>
                  ...
                  <input
                    ...
                    className="w-full accent-[#C86D51] bg-white/20 rounded-lg cursor-pointer h-2"
                  />
                    ...
                    {[1, 10, 25, 50, 100].map((num) => (
                      <button
                        ...
                        className={`px-2 py-1 text-[11px] font-bold rounded-lg ${
                          calcQuantity === num
                            ? 'bg-white text-[#362C2B]'
                            : 'bg-white/10 text-[#EAE2D5] hover:bg-white/20'
                        }`}
                      >
                        {num} pcs
                      </button>
              ...
              <div className="bg-white/10 p-5 rounded-2xl border border-white/15 mb-6 space-y-3">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-[#EAE2D5]">Discount Tier:</span>
                  <span className="font-bold text-white bg-[#C86D51]/80 px-2.5 py-0.5 rounded-full">
                    {activeTier.label}
                  </span>
                </div>
                <div className="flex justify-between items-center text-xs">
                  <span className="text-[#EAE2D5]">Estimated Rate per Piece:</span>
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-[#C86D51] hover:bg-[#B25C42] text-white font-bold rounded-2xl shadow-lg transition-all duration-200 flex items-center justify-center space-x-2 min-h-[44px]"
              >
