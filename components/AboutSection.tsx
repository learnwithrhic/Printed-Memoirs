...
export function AboutSection() {
  return (
    <section id="story" className="py-16 lg:py-24 bg-[#FDFBF6] border-b border-[#EFE2C2]/60">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="bg-white rounded-3xl border border-[#EFE2C2] p-8 sm:p-12 lg:p-16 shadow-sm relative overflow-hidden">
          
          <div className="max-w-3xl mx-auto text-center">
            
            {/* Header Tag */}
            <span className="text-xs font-bold uppercase tracking-widest text-[#777F56] mb-3 block">
              About Printed Memoirs
            </span>

            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#2D321F] tracking-tight mb-8">
              OUR STORY
            </h2>

            {/* Story Text matching prompt text exactly */}
            <div className="space-y-6 text-base sm:text-lg text-[#4E553D] leading-relaxed text-left sm:text-justify font-normal">
              
              <p className="font-serif italic text-xl text-[#2D321F] text-center border-y border-[#EFE2C2] py-4 my-6">
            ...
            <div className="mt-12 pt-8 border-t border-[#EFE2C2] text-center">
              <p className="text-sm font-semibold tracking-widest uppercase text-[#777F56] mb-1">
                Your memory. Your design. Your keepsake.
              </p>
              <p className="font-serif text-2xl font-bold text-[#2D321F]">
                Printed Memoirs.
              </p>
            </div>
