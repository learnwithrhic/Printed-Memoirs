...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 lg:py-24 bg-[#FAF7F2] border-b border-[#EAE2D5]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#EAE2D5] shadow-xs space-y-6">
              ...
              <a
                ...
                className="flex items-center space-x-4 p-4 rounded-2xl bg-[#FAF7F2] hover:bg-[#F3ECE2] transition-colors border border-[#EAE2D5] group"
              >
                <div className="p-3 bg-emerald-100 text-emerald-800 rounded-xl group-hover:scale-105 transition-transform">
                  <MessageSquare className="w-6 h-6" aria-hidden="true" />
                </div>
                <div>
                  <span className="text-xs text-[#8C7A78] font-bold uppercase tracking-wider block">WhatsApp Direct</span>
                  <span className="text-sm font-bold text-[#362C2B]">+971 50 000 0000</span>
              ...
              >
                ...
                <div>
                  <span className="text-xs text-[#8C7A78] font-bold uppercase tracking-wider block">Email Inquiries</span>
                  <span className="text-sm font-bold text-[#362C2B]">hello@printedmemoirs.ae</span>
                </div>
              </a>

              {/* Instagram */}
              <div className="flex items-center space-x-4 p-4 rounded-2xl bg-[#FAF7F2] border border-[#EAE2D5]">
                <div className="p-3 bg-rose-100 text-rose-800 rounded-xl">
                  <Instagram className="w-6 h-6" aria-hidden="true" />
                </div>
                <div>
                  <span className="text-xs text-[#8C7A78] font-bold uppercase tracking-wider block">Social Channels</span>
                  <span className="text-sm font-bold text-[#362C2B]">@printedmemoirs.ae</span>
                  <span className="text-[11px] text-[#8C7A78] block">Instagram & TikTok</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 rounded-2xl bg-[#FAF7F2] border border-[#EAE2D5]">
                ...
                <div>
                  <span className="text-xs text-[#8C7A78] font-bold uppercase tracking-wider block">Workshop Location</span>
                  <span className="text-sm font-bold text-[#362C2B]">United Arab Emirates (UAE)</span>
                  <span className="text-[11px] text-[#8C7A78] block">Express Delivery Across All 7 Emirates</span>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#EAE2D5] shadow-lg">
              <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#362C2B] mb-2">
                GET A QUOTE
              </h3>
              <p className="text-xs text-[#8C7A78] mb-8">
                Fill in your order requirements and our team will get back to you with a formal quote within hours.
              </p>

              {submitted ? (
                <div className="p-8 bg-[#FAF7F2] rounded-2xl border border-[#EAE2D5] text-center space-y-4">
                  <CheckCircle2 className="w-12 h-12 text-[#C86D51] mx-auto" aria-hidden="true" />
                  <h4 className="font-serif text-2xl font-bold text-[#362C2B]">Inquiry Received!</h4>
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-[#C86D51] text-white font-bold text-xs rounded-full"
                  >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-[#EAE2D5] focus:outline-none focus:ring-2 focus:ring-[#C86D51] text-sm text-[#362C2B] bg-white"
                      >
